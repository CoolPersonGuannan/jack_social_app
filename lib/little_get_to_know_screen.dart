...
class LittleGetToKnowScreen extends StatefulWidget {
  const LittleGetToKnowScreen({super.key});

  @override
  State<LittleGetToKnowScreen> createState() => _LittleGetToKnowScreenState();
}

class _LittleGetToKnowScreenState extends State<LittleGetToKnowScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("A Little Bit About Yourself"),
      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...[
                              ...
                              Text('Tick This if you are eating 3 meals today :D',
                                  style: Theme.of(context).textTheme.titleMedium),
                              Checkbox(
                              ...
                              Text('Did you Progress towards any of your Goals? Click if yes',
                                  style: Theme.of(context).textTheme.titleMedium),
                              Checkbox(
                              ...
                              Text('Are you feeling stress? Click if yes',
                                  style: Theme.of(context).textTheme.titleMedium),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                crossAxisAlignment: CrossAxisAlignment.center,
