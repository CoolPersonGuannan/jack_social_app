...
class RealTimeFirebase extends StatefulWidget {
  const RealTimeFirebase({Key? key}) : super(key: key);

  @override
  _RealTimeFirebaseState createState() => _RealTimeFirebaseState();
}

class _RealTimeFirebaseState extends State<RealTimeFirebase> {
  int _counter = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("CrazyPeopleInBio"),
      ),
      body: Column(
        children: [
          Flexible(
